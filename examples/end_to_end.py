"""End-to-end Exu run, fully offline, in a few seconds.
...
def main() -> None:
    with tempfile.TemporaryDirectory() as workspace:
        ...
        model = ExuModel(
            encoder, ExuConfig(encoder_name="tiny", num_decision_layers=1, dropout=0.0)
        )
        ...
        print(f"wrote {checkpoint / 'exu.json'}")
