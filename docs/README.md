...
with the reasoning and the traps, read the [Exu guide](exu-guide.md). Then pick
...
| [exu-guide.md](exu-guide.md) | You are starting a model and want the whole picture, with the traps |
...
| [exu-guide.pt-BR.md](exu-guide.pt-BR.md) | You prefer to read the walkthrough in Portuguese |
