# Como construir um modelo de decisão calibrado com RLCD
...
RLCD quer dizer Reinforcement Learning for Calibrated Decisions. A recompensa é
...
gate de ação em cima dessa confiança. A receita aberta seguida aqui é o
...
curto com cada um, e só então decida. O default do `RLCDConfig` é um BERT
