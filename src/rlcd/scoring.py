...
only by reporting the true distribution. That property is the whole reason RLCD
exists: whatever the optimizer does, the only way to raise the reward is to be
