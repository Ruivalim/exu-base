...
Training is a CLI::
    ...
    rlcd-train --mode rlcd --train data.jsonl --validation data.jsonl ...
    rlcd-evaluate --checkpoint artifacts/my-checkpoint --data data.jsonl
"""
...
from .model import ActionCosts, DecisionOutput, RLCDConfig, RLCDModel, masked_softmax
from .policy import (
    PolicyConfig,
    PolicyMetrics,
    group_advantages,
